...
export const messageGenerationInputSchema = z.object({
  ...
  couponSnapshot: z
    .object({
      ...
      externalCouponId: z.string().nullable(),
      ...
      minimumSpend: z.string().nullable(),
      ...
      applicability: z.enum(["CONFIRMED", "CONDITIONAL"]),
      startsAt: z.string().datetime().nullable(),
      expiresAt: z.string().datetime().nullable(),
      validatedAt: z.string().datetime(),
      source: z.string().min(1),
      itemPrice: z.string(),
      discountAmountCalculated: z.string().nullable(),
      effectivePriceCalculated: z.string().nullable(),
      effectiveDiscountPercentage: z.string().nullable(),
    })
    .optional()
    .nullable(),
